		...
		if ( !isset($_POST['bsa_ad_id']) || isset($example) ) { // example content if new ad
			$ads = array(
				array(
					...
					"html" => '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Jv6_N3Te3D0?autoplay=1&enablejsapi=1&loop=1&modestbranding=1&playsinline=1&color=white&mute=1" frameborder="0" allow="accelerometer; autoplay="1"; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
				)
			);
			if ( isset($example) ) {
			...
			$ads = array(
				array(
					...
					"youtube_iframe" => '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/.$url.?autoplay=1&enablejsapi=1&loop=1&modestbranding=1&playsinline=1&color=white&mute=1" frameborder="0" allow="accelerometer; autoplay="1"; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
					"html" => bsa_ad($_POST['bsa_ad_id'], "youtube_iframe")
